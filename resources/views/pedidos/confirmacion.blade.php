...
<div class="row justify-content-center">
    <div class="col-md-8">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        @if($pedido['fecha_entrega'])
                            <p><strong>Entrega estimada:</strong> {{ $pedido['fecha_entrega'] }}</p>
                        @endif
                    </div>
                </div>
            </div>
        ...
        <div class="text-center mt-4">
            <a href="{{ route('pedidos.historial') }}" class="btn btn-outline-success me-2">
                <i class="fa fa-history"></i> Ver Historial de Pedidos
            </a>
            <a href="{{ route('productos.catalog') }}" class="btn btn-success">
