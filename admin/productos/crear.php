...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO productos (categoria_id, nombre, descripcion, precio, imagen, stock, unidad, origen, activo) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
    $stmt = mysqli_prepare($con, $sql);
    mysqli_stmt_bind_param($stmt, 'issdsisss', $categoria_id, $nombre, $descripcion, $precio, $imagen, $stock, $unidad, $origen, $activo);
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        $error = "Error al crear el producto: " . mysqli_error($con);
    }
}
?>
...
<head>
    ...
    <title>Crear Producto - VerdeVida Market</title>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="text-center">
                                        <img id="preview" src="#" alt="Vista previa" class="preview-img mt-3">
                                    </div>
                                </div>
                            </div>
